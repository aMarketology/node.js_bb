...
export default function AuthModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  const { signIn, signInWithGoogle, signUp, connectWallet } = useAuth()
  ...
  const handleGoogleSignIn = async () => {
    ...
    if (success) {
      ...
      // Modal will close after OAuth redirect completes
    } else {
            ...
            <>
              ...
              <div className="max-w-md mx-auto space-y-6">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full px-6 py-4 rounded-xl font-semibold text-dark bg-white hover:bg-gray-100 transition-colors flex items-center justify-center gap-3 disabled:opacity-50"
                >
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-dark text-gray-500">Or use email</span>
                  </div>
                </div>
