...
export const TEST_ACCOUNTS = {
  ...
  mac: {
    ...
    // Ed25519 Keys (vault-encrypted in production, exposed for testing)
    publicKey: 'ec6941c71740e192bbf5933d5f9cc18ea161329ce864da900d8de73d45c28752',
    privateKey: '(vault-encrypted)',  // Not exposed in test mode
    
    // Blockchain Addresses (160-bit)
    l1Address: 'L1_94B3C863E068096596CE80F04C2233B72AE11790',
    l2Address: 'L2_94B3C863E068096596CE80F04C2233B72AE11790',
    
    // Vault info (for secure wallet pattern)
    vaultSalt: '579a5c28a02f8c3ecc2801545a216cec',
    vaultEncryptedBlob: 'U2FsdGVkX19443Y8LJ1PaUV6/aG4Ctod88tWo7AVDftZlcgWurkSGAhVEAScVQ91+Ew9iP0d588HfIUYlXQPGEmIMDhjj3M6cDPbDtnTZFh848l0Z71CjV0CpB41Avad',
    testPassword: 'MacSecurePassword2026!',
    
    // Capabilities
    capabilities: [
      'Vault-encrypted wallet (production pattern)',
      'Sign transactions (Ed25519)',
      'L1 transfers',
      'Bridge L1 → L2',
      'Withdraw L2 → L1',
